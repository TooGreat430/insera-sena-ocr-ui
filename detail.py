...
10. Jika dokumen Bill of Lading (BL) TIDAK TERSEDIA:
- Seluruh field bl_* WAJIB diisi dengan string "null".
11. Jika dokumen Cerificate of Origin (COO) TIDAK TERSEDIA:
- Seluruh field coo_* WAJIB diisi dengan string "null".
